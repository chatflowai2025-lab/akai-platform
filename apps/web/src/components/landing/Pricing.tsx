...
const PLANS = [
  {
    ...
    features: [
      'Sales agent — books meetings automatically',
      'Email Guard — triages every enquiry',
      'Voice agent (Sophie) — calls your leads',
      'Calendar — books appointments 24/7',
      '200 leads/mo · 60 voice mins',
    ],
  ...
  },
  {
    ...
    features: [
      'All 10 AKAI agents unlocked',
      'Sales · Voice · Email · Ads · Social · Recruit · Web · Proposals · Calendar · Health',
