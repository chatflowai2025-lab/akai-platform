const PLANS = [
  {
    ...
    price: '$147',
    period: '/mo',
    description: 'One AI skill, fully operational.',
    features: [
      '1 AKAI skill of your choice',
  ...
  },
  {
    ...
    price: '$497',
    period: '/mo',
    description: 'Three skills, full automation stack.',
    features: [
      '3 AKAI skills of your choice',
  ...
  },
  {
    ...
    price: '$1,497',
    period: '/mo',
    description: 'All 9 skills. Unlimited everything.',
    features: [
      'All 9 AKAI skills',
