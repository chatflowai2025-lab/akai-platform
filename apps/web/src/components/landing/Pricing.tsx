...
const PLANS = [
  {
    ...
    features: ['1 AKAI module', 'Unlimited leads', 'Sophie AI calling', 'Basic dashboard', 'Email support'],
  ...
  },
  {
    ...
    features: ['3 AKAI modules', 'Unlimited leads + calls', 'Team seats (5)', 'Advanced analytics', 'Priority support', 'Onboarding call'],
    cta: 'Start Free Trial',
    highlight: true,
  },
  {
    ...
    features: ['All 5 AKAI modules', 'Unlimited everything', 'Unlimited team seats', 'White-label option', 'Success manager', 'SLA guarantee'],
    cta: 'Start Free Trial',
    highlight: false,
  },
];
