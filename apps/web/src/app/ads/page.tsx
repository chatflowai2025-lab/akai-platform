  ...
  return (
    <section className="bg-[#111] border border-[#1f1f1f] rounded-2xl p-6">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-xl bg-[#0d0d0d] border border-[#2a2a2a] flex items-center justify-center text-2xl flex-shrink-0">
          📊
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <h2 className="text-white font-bold text-sm">Google Ads</h2>
            <span className="text-xs px-2 py-0.5 rounded-full bg-gray-500/10 border border-gray-500/20 text-gray-500 font-medium">
              Not connected
            </span>
          </div>
          <p className="text-xs text-gray-500">
            Connect your Google Ads account to publish campaigns directly and track performance in real time.
          </p>
        </div>
        <button
          ...
          onClick={() => alert('Google Ads integration coming soon! Your campaigns are ready to copy & paste in the meantime.')}
        >
          Connect Google Ads
        </button>
      </div>
  ...
  const buildCampaign = async () => {
    ...
    try {
      const res = await fetch('/api/ads/generate', {
        ...
        body: JSON.stringify({ businessName, targetAudience, location, budget, goal }),
      });
  ...
  return (
    <section className="bg-[#111] border border-[#1f1f1f] rounded-2xl p-6">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          <h2 className="text-white font-bold text-base">Campaign Builder</h2>
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={() => sendMessage('create ads campaign')}
    ...
    <DashboardLayout>
      <header className="flex items-center justify-between px-8 py-4 border-b border-[#1f1f1f] bg-[#080808]">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">AI-powered Google Ads campaign builder</p>
        </div>
        <span className="text-xs px-3 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 font-medium">
          Beta
        </span>
      </header>
