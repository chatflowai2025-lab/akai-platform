      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="rounded-2xl border border-[#D4AF37]/30 p-10 text-center" style={{ background: 'linear-gradient(135deg, #0d0d0d 0%, #111 100%)' }}>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto mb-8">
            {[
              { name: 'Starter', price: '$199', period: '/mo', desc: 'Core AI team' },
              { name: 'Growth', price: '$599', period: '/mo', desc: 'Full platform', highlight: true },
              { name: 'Agency', price: '$1,200', period: '/mo', desc: 'Multi-client' },
            ].map(p => (
